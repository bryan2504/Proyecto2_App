...
class KanjisControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create kanji" do
    assert_difference('Kanji.count') do
      post kanjis_url, params: { kanji: { explicacion: @kanji.explicacion, leccion: @kanji.leccion } }
    end
  ...
  test "should update kanji" do
    patch kanji_url(@kanji), params: { kanji: { explicacion: @kanji.explicacion, leccion: @kanji.leccion } }
